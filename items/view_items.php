<html>
    ...
    <body>
        ...
        $sql_where = ($search !== "") ? "" : "WHERE name like '%$search%' ";
        $sql = "SELECT name, category AS category, MIN(id) AS id, MIN(image_url) AS image_url, count(*) as quantity FROM items $sql_where GROUP BY name";
