<html>
    ...
    $box_check_sql = "SELECT * FROM locations WHERE number = '$box_number'";
    ...
    if ($box_check_result->num_rows <= 0) {
        ...
        echo "<form action ='../locations/insert_box.php' method = 'post'>
    ...
    */
        ...
        if ($conn->query($sql) === TRUE ) {
            ...
            */
            ...
            if ($conn->query($joinsql) === TRUE && $conn->query($modelsql) === TRUE) {
